# csv file has image name and label 
# img directory (downloads, images) has the actual images with names that correspond to the csv 
...
if __name__ == "__main__":
    ...
    train_dataset = MyDataset(
        csv_path="image_train.csv",
        img_dir=#insert home directory label!!!!,
